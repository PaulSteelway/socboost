...
class UnitPay
{
    ...
    private $supportedUnitpayMethods = array('initPayment', 'massPayment', 'getPayment', 'getSubscription', 'closeSubscription');
    private $requiredUnitpayMethodsParams = array(
        'initPayment' => array('desc', 'account', 'sum'),
        'getPayment' => array('paymentId'),
        'massPayment' => array('sum', 'purse', 'login', 'transactionId', 'secretKey', 'paymentType'),
        'getSubscription' => array('secretKey', 'subscriptionId'),
        'closeSubscription' => array('secretKey', 'subscriptionId')
    );
