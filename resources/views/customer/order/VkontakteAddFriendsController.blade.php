...
@section('title', __("VK Followers for personal page") . ' - ' . __('site.site'))
...
@section('content')
    <div class="row">
        <div class="service-content col-md-8">
            ...
            <form name="add_order" method="post" action="{{ route('add_order', ['service' => 'SERVICE_ADD_ORDER_VKONTAKTE_ADD_FRIENDS']) }}">
                <input type="hidden" name="type" value="vkontakte-add-friends">
                <h1>{{ __("VK Followers for personal page") }}</h1>
                <br>
                <div class="row">
                    <div class="label-name col-md-4">{{ __("Price / 1:") }}</div>
                    <div class="col-md-8 priceOne"><span id="price_base"><strong>{{ socialboosterPrice('SERVICE_ADD_ORDER_VKONTAKTE_ADD_FRIENDS_PRICE') }}</strong></span> {{ session()->has('lang') && session('lang') == 'ru' ? '₽' : '$' }}</div>
                </div>
                {{--<div class="row">--}}
                    ...
                    {{--<div class="col-md-8 options">--}}
                        {{--<select class="form-control shop-options-s" name="options[country]">--}}
                            ...
                            {{--<option class="0.10"--}}
                                    {{--value="1">--}}
                                {{--Россия (+0,1 {{ session()->has('lang') && session('lang') == 'ru' ? '₽' : '$' }})--}}
                            {{--</option>--}}
                            {{--<option class="0.05"--}}
                                    {{--value="2">--}}
                                {{--Украина (+0,05 {{ session()->has('lang') && session('lang') == 'ru' ? '₽' : '$' }})--}}
                            {{--</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="row">--}}
                    ...
                    {{--<div class="col-md-8 options">--}}
                        {{--<select class="form-control shop-options-s" name="options[male]">--}}
                            ...
                            {{--<option class="0.05"--}}
                                    {{--value="1">--}}
                                {{--Мужской (+0,05 {{ session()->has('lang') && session('lang') == 'ru' ? '₽' : '$' }})--}}
                            {{--</option>--}}
                            {{--<option class="0.05"--}}
                                    {{--value="2">--}}
                                {{--Женский (+0,05 {{ session()->has('lang') && session('lang') == 'ru' ? '₽' : '$' }})--}}
                            {{--</option>--}}
                        {{--</select>--}}
                    {{--</div>--}}
                {{--</div>--}}
                ...
                <input type="hidden" name="count_min" value="10"/>
