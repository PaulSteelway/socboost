...
@section('title', __('Расскажем как набрать 1 миллион подписчиков в Instagram за 1 месяц') . ' - ' . __('site.site'))
                ...
                <div class="row">
                    <div class="col">
                        <div class="tiktok-course__block">
                            <div class="tiktok-course__title">{{__('Расскажем как набрать 1 миллион подписчиков в Instagram за 1 месяц')}}</div>
                            <div class="tiktok-course__subtitle">{{__('Для кого этот курс?')}}</div>
                            <div class="tiktok-course__img">
                                <img src="/images/instagram-course.png" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="app__block">
                            ...
                            <div class="app__img">
                                <img src="/images/for-whom-is-the-course-instagram.png" alt="">
                            </div>
                    ...
                    <div class="col">
                        <div class="tiktok__best-offer-block">
                            <div class="tiktok__best-offer-title">{{__('Лучшее предложение для вас!')}}
                                <span class="old_price">9750 ₽</span><span class="new_price"> 1990 ₽</span>
                            </div>
                            <div class="tiktok__best-offer-img">
                                <img src="/images/instagram-course1.png" alt="">
                            </div>
